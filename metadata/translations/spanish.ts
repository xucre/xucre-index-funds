...
const values : TranslationType = {
  ...
  Edit: {
    ...
    risk_help_text_title: 'Tolerancia al Riesgo y Niveles de Inversión en Cripto',
    risk_help_text_body1: 'La tolerancia al riesgo es clave en cripto. Nuestro app ofrece tres niveles:',
    risk_help_text_bullet1: 'Agresivo: Para quienes aceptan alta volatilidad a cambio de grandes ganancias, incluyendo altcoins y proyectos DeFi.',
    risk_help_text_bullet2: 'Moderado: Un balance entre crecimiento y estabilidad, con activos como Ethereum y Binance Coin, junto a protocolos DeFi.',
    risk_help_text_bullet3: 'Conservador: Minimiza la volatilidad con Bitcoin y stablecoins como USDC, buscando rendimiento estable',
    risk_help_text_body2: 'Elige el nivel que mejor se alinee con tus metas y perfil de riesgo.',
  },
  Home: {
